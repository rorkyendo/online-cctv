...
<div class="card shadow-sm">
    <div class="card-header border-0 pt-6">
        <div class="card-title"><h3 class="fw-bold">Tambah Hak Akses</h3></div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('/panel/masterData/tambahHakAkses/save') }}">
            @csrf
            <div class="mb-6">
                <label class="form-label required fw-semibold">Nama Hak Akses</label>
                <input type="text" name="nama_hak_akses" class="form-control"
                       placeholder="Contoh: Admin, Operator, Viewer Gedung A"
                       value="{{ old('nama_hak_akses') }}" required />
            </div>
            ...
            <!-- CCTV Group Access Permissions (KEY FEATURE) -->
            <div class="mb-6">
                <h5 class="fw-bold mb-3">
                ...
                <div class="alert alert-info mb-4">
                    ...
                    <strong>Jika tidak ada group yang dipilih</strong>, pengguna dengan hak akses ini dapat mengakses
...
<script>
// When parent module checkbox is toggled, toggle all child modules
